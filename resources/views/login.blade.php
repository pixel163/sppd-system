...
<body class="min-h-screen bg-white font-['Inter',sans-serif]">
    ...
    <main class="flex min-h-screen w-full bg-white">
        ...
        {{-- =========================
             LEFT BRAND PANEL
        ========================== --}}
        <section class="relative flex min-h-screen w-[450px] shrink-0 flex-col items-start justify-between overflow-hidden p-12">

            {{-- Background Image + Blue Overlay --}}
            <div class="pointer-events-none absolute inset-0">

                <img src="https://www.figma.com/api/mcp/asset/7f81966a-4470-489f-a5f5-79b632c40f45.png"
            ...
            <div class="relative flex w-full flex-col items-start gap-8">
                ...
                {{-- Logo --}}
                <div class="flex size-16 items-center justify-center rounded-2xl bg-white shadow-[0px_4px_4px_rgba(0,0,0,0.06)]">
                ...
                <div class="h-0 w-[60px]">
                    ...
                    <img src="https://www.figma.com/api/mcp/asset/04979a65-f498-4dd8-a305-6e50900b358d.svg"
                        alt="" class="block h-full w-full">
        ...
        {{-- =========================
             LOGIN AREA
        ========================== --}}
        <section class="flex min-w-0 flex-1 items-start justify-center px-16 pt-[110px]">
            ...
            <div class="w-full max-w-[422px]">
                ...
                {{-- Form --}}
                <form method="POST" action="{{ route('login') }}" class="mt-[64px] flex w-full flex-col gap-6">
                    @csrf
                    ...
                    <div class="flex w-full items-center justify-between gap-4">
                        ...
                        <a href="https://example.com/forgot"
                            target="_blank"
