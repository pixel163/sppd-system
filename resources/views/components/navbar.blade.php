<header
    class="flex min-h-[72px] flex-col gap-5 border-b border-[#e2e8f0] bg-white 
    px-5 py-4 sm:px-7 lg:flex-row lg:items-center lg:justify-between lg:px-8">
    ...
    <div class="flex items-center justify-between gap-4 sm:justify-end">
        ...
        <div class="relative">
            ...
            <button
                ...
                <div class="flex size-9 items-center justify-center rounded-full bg-[#eff6ff]">
                    <i
                        data-lucide="user"
