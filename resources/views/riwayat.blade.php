...
<div class="flex min-h-screen">
    ...
    <aside class="flex w-[260px] shrink-0 flex-col gap-6 border-r border-[#e2e8f0] bg-white px-4 py-6">
        ...
        <nav class="flex flex-col gap-1">
            ...
            <a href="/dashboard" class="flex items-center gap-3 rounded-xl px-4 py-3">
                <img
            ...
            {{-- <a href="#" class="flex items-center gap-3 rounded-xl px-4 py-3">
                ...
                <span class="text-[14px] font-medium text-[#0d6efd]">
                    Riwayat Pengajuan
                </span>
            </a> --}}
            ...
            <a href="/dokumen" class="flex items-center gap-3 rounded-xl px-4 py-3">
                <img
